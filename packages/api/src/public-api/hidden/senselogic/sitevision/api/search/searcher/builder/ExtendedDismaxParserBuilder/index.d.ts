...
interface ExtendedDismaxParserBuilder {
  /**
   * Adds a query field.
   *
   * <p>
   ...
   * @return this builder
   */
  addQueryField(aQueryField: java.lang.String): ExtendedDismaxParserBuilder;
   ...
   */
  setTieBreaker(aTieBreaker: double): ExtendedDismaxParserBuilder;
   ...
   * @since Sitevision 4.0.2
   */
  setUserFields(aUserFields: java.lang.String): ExtendedDismaxParserBuilder;
  ...
  setMinimumShouldMatch(
    aMinimumShouldMatch: java.lang.String
  ): ExtendedDismaxParserBuilder;
   ...
   * @since Sitevision 4.0.2
   */
  addPhraseField(aPhraseField: java.lang.String): ExtendedDismaxParserBuilder;
   ...
   * @since Sitevision 4.0.2
   */
  setBoostQuery(aBoostQuery: java.lang.String): ExtendedDismaxParserBuilder;
  ...
  addAdditiveBoostFunction(
    aAdditiveBoostFunction: java.lang.String
  ): ExtendedDismaxParserBuilder;
  ...
  addMultiplicativeBoostFunction(
    aMultiplicativeBoostFunction: java.lang.String
  ): ExtendedDismaxParserBuilder;
