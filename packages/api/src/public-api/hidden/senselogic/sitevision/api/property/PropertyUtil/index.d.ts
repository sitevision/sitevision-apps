...
interface PropertyUtil {
  ...
  getNestedString(
    ...
    aNodePropertyName: java.lang.String,
    aPropertyName: java.lang.String,
    aDefaultValue: java.lang.String
  ): string;
   ...
   * @since Sitevision 3.5
   */
  getBinary(aNode: Node, aPropertyName: java.lang.String): Binary;
   ...
   */
  getString(aNode: Node, aPropertyName: java.lang.String): string;
   ...
   * @since Sitevision 3.5
   */
  getStringEscaped(aNode: Node, aPropertyName: java.lang.String): string;
   ...
   */
  getInt(aNode: Node, aPropertyName: java.lang.String): number;
   ...
   * @since Sitevision 2.6.1_09
   */
  getDouble(aNode: Node, aPropertyName: java.lang.String): number;
   ...
   * @return the value for aPropertyName as <code>boolean</code>. If no property exists or it isn't compatible with a <code>boolean</code>, <code>false</code> is returned.
   */
  getBoolean(aNode: Node, aPropertyName: java.lang.String): boolean;
   ...
   * @return the value for aPropertyName as <code>Node</code>. If no property exists or it isn't a <code>Node</code>, <code>null</code> is returned.
   */
  getNode(aNode: Node, aPropertyName: java.lang.String): Node;
  ...
  getEnabledNode(
    aNode: Node,
    aEnablingPropertyName: java.lang.String,
    aNodePropertyName: java.lang.String
  ): Node;
  ...
  getEnabledString(
    aNode: Node,
    aEnablingPropertyName: java.lang.String,
    aStringPropertyName: java.lang.String
  ): string;
   ...
   */
  getCalendar(aNode: Node, aPropertyName: java.lang.String): unknown;
  ...
  getCalendar(
    aNode: Node,
    aPropertyName: java.lang.String,
    aDefaultValue: java.util.Calendar
  ): unknown;
   ...
   */
  getStrings(aNode: Node, aPropertyName: java.lang.String): unknown[];
   ...
   * @since Sitevision 3.5
   */
  getStringsEscaped(aNode: Node, aPropertyName: java.lang.String): unknown[];
