...
interface NodeTreeUtil {
   ...
   */
  getNode(aNode: Node, aRelPath: java.lang.String): Node;
   ...
   */
  findPortletByName(aPageNode: Node, aPortletName: java.lang.String): Node;
