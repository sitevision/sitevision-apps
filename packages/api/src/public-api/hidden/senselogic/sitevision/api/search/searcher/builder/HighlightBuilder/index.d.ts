...
interface HighlightBuilder {
   ...
   * @return this builder
   */
  addHighlightedField(aHighlightedField: java.lang.String): HighlightBuilder;
   ...
   */
  setFragmentCharCount(aCharCount: int): HighlightBuilder;
   ...
   * @return this builder
   */
  setFragmentPreString(aPreString: java.lang.String): HighlightBuilder;
   ...
   * @return this builder
   */
  setFragmentPostString(aPostString: java.lang.String): HighlightBuilder;
