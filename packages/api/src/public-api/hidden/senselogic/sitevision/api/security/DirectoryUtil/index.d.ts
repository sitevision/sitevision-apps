...
import Property from "../../../../../javax/jcr/Property";
...
interface DirectoryUtil {
   ...
   */
  search(aSearchFilter: java.lang.String): unknown[];
   ...
   * @see #search(String)
   */
  search(aSearchFilter: java.lang.String, aDirectoryNode: Node): unknown[];
   ...
   */
  search(
    aSearchFilter: java.lang.String,
    aDirectoryNode: Node,
    aSearchBase: java.lang.String
  ): unknown[];
   ...
   */
  getNodeByDN(aDirectoryObjectDN: java.lang.String): Node;
  ...
  getAttributeAsProperty(
    ...
    anAttributeName: java.lang.String
  ): Property;
