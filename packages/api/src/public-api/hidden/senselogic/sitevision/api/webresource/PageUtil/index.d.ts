 ...
 * </p>Name of the property specifying if a page is visible in menus. It corresponds to the sv:page property <code>visibleInMenus</code>.
 * <p>The property value must be of type <code>Boolean</code>.</p>Name of the property specifying the title of a page. It corresponds to the sv:page property <code>title</code>.
 * <p>The property value must be of type <code>String</code>.</p>Name of the property specifying the short id for a page. It corresponds to the sv:page property <code>shortId</code>.
 * <p>The property value must be of type <code>String</code>.</p>Name of the property specifying locale used by the page. It corresponds to the sv:page property <code>locale</code>.
 * <p>
 ...
 * </p>Name of the property specifying if the page is indexable. It corresponds to the sv:page property <code>robotsIndex</code>.
 * <p>The property value must be of type <code>Boolean</code>.</p>Name of the property specifying the creation date of the page. It corresponds to the sv:page property <code>creationDate</code>.
 * <p>The property value must be of type <code>Date</code> or a <code>String</code> on format yyyy-MM-dd HH:mm:ss where
 * HH:mm:ss is optional (defaults to 00:00:00).</p>Name of the property specifying the creator of the page. It corresponds to the sv:page property <code>createdBy</code>.
 * <p>The property value must be a {@link javax.jcr.Node} with primary node type sv:user or sv:systemUser.</p>Name of the property specifying the last modified date of the page. It corresponds to the sv:page property <code>lastModifiedDate</code>.
 * <p>The property value must be of type <code>Date</code> or a <code>String</code> on format yyyy-MM-dd HH:mm:ss where
 * HH:mm:ss is optional (defaults to 00:00:00).</p>Name of the property specifying the last modifier of the page. It corresponds to the sv:page property <code>lastModifiedBy</code>.
 * <p>The property value must be of type {@link javax.jcr.Node} of type sv:user or sv:systemUser.</p>Name of the property specifying the last published date of a page. It corresponds to the sv:page property <code>lastPublishDate</code>.
 * <p>The property value must be of type <code>Date</code> or a <code>String</code> on format yyyy-MM-dd HH:mm:ss, where
 * HH:mm:ss is optional (defaults to 00:00:00).</p>Name of the property specifying the last publisher of a page. It corresponds to the sv:page property <code>lastPublishedBy</code>.
 * <p>The property value must be a {@link javax.jcr.Node} with primary node type sv:user or sv:systemUser.</p>Name of the property specifying the published date of a page. It corresponds to the sv:page property <code>publishDate</code>.
 * <p>The property value must be of type <code>Date</code> or a <code>String</code> on format yyyy-MM-dd HH:mm:ss, where
 * HH:mm:ss is optional (defaults to 00:00:00).</p>Name of the property specifying the publisher of a page. It corresponds to the sv:page property <code>publishedBy</code>.
...
interface PageUtil {
   ...
   */
  createPage(aParent: Node, aTemplate: Node, aName: java.lang.String): Node;
   ...
   * @throws RepositoryException if something else goes wrong
   */
  updatePage(aPage: Node, properties: java.util.Map): void;
   ...
   * @throws RepositoryException if something else goes wrong
   */
  renamePage(aPage: Node, aName: java.lang.String): void;
}
