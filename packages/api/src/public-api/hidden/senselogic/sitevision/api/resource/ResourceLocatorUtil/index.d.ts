...
interface ResourceLocatorUtil {
   ...
   */
  getNodeByIdentifier(anIdentifier: java.lang.String): Node;
   ...
   * @since Sitevision 3.6.5
   */
  getNodeByPath(anAbsolutePath: java.lang.String): Node;
   ...
   */
  getNodeByUrl(anUrl: java.lang.String): Node;
   ...
   */
  getNodeId(aInternalObject: java.lang.Object): string;
