...
interface ImageUtil {
   ...
   */
  createImages(aParent: Node, aImages: java.util.Map): void;
   ...
   */
  updateBinaryContent(aImage: Node, aUri: java.lang.String): void;
   ...
   */
  renameImage(aImage: Node, aName: java.lang.String): void;
