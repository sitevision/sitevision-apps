import CompoundComparatorBuilder from "../builder/CompoundComparatorBuilder";
...
interface NodeComparatorUtil {
   ...
   */
  getPropertyComparator(aPropertyName: java.lang.String): unknown;
  ...
  getCalendarPropertyComparator(
    aCalendarPropertyName: java.lang.String
  ): unknown;
   ...
   * @since Sitevision 3.6.3
   */
  getIntPropertyComparator(aIntPropertyName: java.lang.String): unknown;
   ...
   * @since Sitevision 3.6.3
   */
  getReversedComparator(aNodeComparator: java.util.Comparator): unknown;
