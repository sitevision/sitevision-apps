...
interface TemplateUtil {
   ...
   */
  getTemplateByName(aTemplateName: java.lang.String): Node;
   ...
   * @since Sitevision 4.1
   */
  getPageTemplateByName(aPageTemplateName: java.lang.String): Node;
   ...
   * @since Sitevision 4.1
   */
  getContentAreaNames(aTemplate: Node): Set<unknown>;
}
