...
interface InstanceCreatorUtil {
   ...
   */
  getDefaultInstance(aQualifiedClassName: java.lang.String): unknown;
   ...
   */
  getArgumentInstance(
    aQualifiedClassName: java.lang.String,
  ...
  getArgumentsInstance(
    aQualifiedClassName: java.lang.String,
    aConstructorArguments: java.util.List
  ): unknown;
   ...
   */
  getByteArgument(aByte: byte): TypedArgument;
   ...
   */
  getShortArgument(aShort: short): TypedArgument;
   ...
   */
  getIntArgument(anInt: int): TypedArgument;
   ...
   */
  getLongArgument(aLong: long): TypedArgument;
   ...
   */
  getFloatArgument(aFloat: float): TypedArgument;
   ...
   */
  getDoubleArgument(aDouble: double): TypedArgument;
   ...
   */
  getCharArgument(aChar: char): TypedArgument;
   ...
   */
  getObjectArgument(aValue: java.lang.Object): TypedArgument;
   ...
   */
  getNullArgument(aQualifiedClassName: java.lang.String): TypedArgument;
   ...
   */
  getEnumArgument(
    aQualifiedEnumClassName: java.lang.String,
    anEnum: java.lang.Object
  ): TypedArgument;
   ...
   */
  getLinkedMap(): Record<unknown, unknown>;
   ...
   */
  getBooleanArray(aSize: int): boolean;
   ...
   * @since Sitevision 4.5.5
   */
  getByteArray(aSize: int): unknown;
   ...
   * @since Sitevision 4.5.5
   */
  getDoubleArray(aSize: int): number;
   ...
   * @since Sitevision 4.5.5
   */
  getFloatArray(aSize: int): number;
   ...
   * @since Sitevision 4.5.5
   */
  getShortArray(aSize: int): number;
   ...
   * @since Sitevision 4.5.5
   */
  getStringArray(aSize: int): string;
   ...
   * @since Sitevision 4.5.5
   */
  getObjectArray(aSize: int): unknown;
}
