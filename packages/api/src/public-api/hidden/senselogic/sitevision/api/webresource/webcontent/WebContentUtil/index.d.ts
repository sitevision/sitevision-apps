...
interface WebContentUtil {
   ...
   */
  updateContent(aNode: Node, aContent: java.lang.String): void;
   ...
   * @see senselogic.sitevision.api.security.PermissionUtil#hasEffectiveWritePermission(Node, Node)
   */
  updateContent(aNode: Node, aContent: java.util.Map): void;
   ...
   * @see senselogic.sitevision.api.security.PermissionUtil#hasEffectiveWritePermission(Node, Node)
   */
  updateContentWithRawHtml(aNode: Node, aContent: java.lang.String): void;
   ...
   * @see senselogic.sitevision.api.security.PermissionUtil#hasEffectiveWritePermission(Node, Node)
   */
  updateContentWithRawHtml(aNode: Node, aContent: java.util.Map): void;
   ...
   * @see senselogic.sitevision.api.security.PermissionUtil#hasEffectiveWritePermission(Node, Node)
   */
  appendContent(aNode: Node, aContent: java.lang.String): void;
   ...
   * @see senselogic.sitevision.api.security.PermissionUtil#hasEffectiveWritePermission(Node, Node)
   */
  appendContent(aNode: Node, aContent: java.util.Map): void;
   ...
   * @see senselogic.sitevision.api.security.PermissionUtil#hasEffectiveWritePermission(Node, Node)
   */
  appendContentWithRawHtml(aNode: Node, aContent: java.lang.String): void;
   ...
   * @see senselogic.sitevision.api.security.PermissionUtil#hasEffectiveWritePermission(Node, Node)
   */
  appendContentWithRawHtml(aNode: Node, aContent: java.util.Map): void;
   ...
   * @since Sitevision 3.6
   */
  resolveToResourceURL(aNode: Node, aUnresolvedURL: java.lang.String): string;
}
