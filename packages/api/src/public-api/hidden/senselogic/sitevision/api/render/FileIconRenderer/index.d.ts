...
interface FileIconRenderer {
   ...
   */
  setLocale(aLocale: java.util.Locale): void;
   ...
   */
  loadDefaultIconByContentType(aContentType: java.lang.String): boolean;
   ...
   */
  loadDefaultIconByURI(aURI: java.lang.String): boolean;
   ...
   * @return <code>true</code> if a default file icon was loaded, <code>false</code> if not
   */
  loadDefaultIconByFileExtension(aFileExtension: java.lang.String): boolean;
 ...
 * Removes loaded default icon (does nothing if no default icon is loaded)
   ...
   */
  loadIconByContentType(aContentType: java.lang.String): boolean;
   ...
   * @return <code>true</code> if a file icon was loaded, <code>false</code> if not
   */
  loadIconByURI(aURI: java.lang.String): boolean;
   ...
   * @return <code>true</code> if a file icon was loaded, <code>false</code> if not
   */
  loadIconByFileExtension(aFileExtension: java.lang.String): boolean;
