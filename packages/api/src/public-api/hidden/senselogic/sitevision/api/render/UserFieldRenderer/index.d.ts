...
interface UserFieldRenderer {
   ...
   */
  isValidFieldName(aUserFieldName: java.lang.String): boolean;
   ...
   */
  render(aUserFieldName: java.lang.String): string;
   ...
   * @see #render(String)
   */
  renderPlain(aUserFieldName: java.lang.String): string;
   ...
   * @since Sitevision 3.6
   */
  getPlainUserFieldValueAsHtml(aPlainUserFieldValue: java.lang.String): string;
}
