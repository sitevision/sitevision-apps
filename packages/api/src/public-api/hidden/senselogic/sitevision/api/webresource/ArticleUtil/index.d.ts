...
interface ArticleUtil {
   ...
   */
  createArticle(aParent: Node, aTemplate: Node, aName: java.lang.String): Node;
   ...
   * @throws RepositoryException if something else goes wrong
   */
  updateArticle(anArticle: Node, properties: java.util.Map): void;
   ...
   * @throws RepositoryException if something else goes wrong
   */
  renameArticle(anArticle: Node, aName: java.lang.String): void;
}
