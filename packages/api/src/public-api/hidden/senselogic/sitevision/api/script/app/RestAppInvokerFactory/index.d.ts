import RestAppInvoker from "../RestAppInvoker";
...
interface RestAppInvokerFactory {
  /**
   ...
   */
  fromPath(aPath: java.lang.String): RestAppInvoker;
   ...
   */
  fromIdentifier(aIdentifier: java.lang.String): RestAppInvoker;
}
