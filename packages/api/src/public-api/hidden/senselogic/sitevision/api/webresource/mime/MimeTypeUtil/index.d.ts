 ...
 * </p>The generic <code>application/octet-stream</code> MIME type.
 *
...
interface MimeTypeUtil {
   ...
   */
  getMimeType(aFileExtensionExpression: java.lang.String): string;
   ...
   */
  getMimeType(
    aFileExtensionExpression: java.lang.String,
    aFallbackMimeType: java.lang.String
  ): string;
   ...
   */
  getExtension(aMimeType: java.lang.String): string;
  ...
  getExtension(
    ...
    aFallbackExtension: java.lang.String
  ): string;
   ...
   */
  isImageType(aFileExtensionExpression: java.lang.String): boolean;
   ...
   */
  isTextType(aFileExtensionExpression: java.lang.String): boolean;
   ...
   * @since Sitevision 4.1
   */
  isXmlType(aFileExtensionExpression: java.lang.String): boolean;
   ...
   * @since Sitevision 4.1
   */
  isVideoType(aFileExtensionExpression: java.lang.String): boolean;
   ...
   * @since Sitevision 4.1
   */
  isCompressedType(aFileExtensionExpression: java.lang.String): boolean;
   ...
   * @since Sitevision 4.1
   */
  isMSWordType(aFileExtensionExpression: java.lang.String): boolean;
   ...
   * @since Sitevision 4.1
   */
  isMSExcelType(aFileExtensionExpression: java.lang.String): boolean;
   ...
   * @since Sitevision 4.1
   */
  isMSPowerpointType(aFileExtensionExpression: java.lang.String): boolean;
   ...
   * @since Sitevision 4.1
   */
  isMSOfficeType(aFileExtensionExpression: java.lang.String): boolean;
   ...
   */
  isFontType(aFileExtensionExpression: java.lang.String): boolean;
}
