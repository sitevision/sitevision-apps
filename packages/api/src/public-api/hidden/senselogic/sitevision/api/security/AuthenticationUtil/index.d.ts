...
interface AuthenticationUtil {
   ...
   */
  logout(
    aServletRequest: javax.servlet.http.HttpServletRequest,
   ...
   * @since Sitevision 2.6.2_06
   */
  reLogin(aServletRequest: javax.servlet.http.HttpServletRequest): void;
   ...
   * @since Sitevision 2.6.2_06
   */
  reLogin(aPortletRequest: javax.portlet.PortletRequest): void;
}
