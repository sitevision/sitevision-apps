...
interface ColorUtil {
   ...
   */
  getColorByName(aColorName: java.lang.String): Node;
   ...
   */
  getColorByName(aColorName: java.lang.String, aDefaultValue: Node): Node;
   ...
   */
  getColorByHtmlHexValue(aHexString: java.lang.String): Node;
