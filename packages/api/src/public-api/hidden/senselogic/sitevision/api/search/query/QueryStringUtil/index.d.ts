...
interface QueryStringUtil {
   ...
   * @since Sitevision 8.2
   */
  stripTrailingAnyChars(aQueryString: java.lang.String): string;
   ...
   * @since Sitevision 10
   */
  stripLocalParams(aQueryString: java.lang.String): string;
   ...
   */
  removeQuerySyntaxChars(aQueryString: java.lang.String): string;
   ...
   * @since Sitevision 8.2
   */
  smartWildcard(aQueryString: java.lang.String): string;
   ...
   */
  splitToQueryParts(
    aStringToSplit: java.lang.String,
    aSplitExpression: java.lang.String
  ): string;
  ...
  splitCollectionToQueryParts(
    aStringsToSplit: java.util.Collection,
    aSplitExpression: java.lang.String
  ): string;
   ...
   */
  getFieldQuery(
    aFieldName: java.lang.String,
    aValueExpression: java.lang.String
  ): string;
   ...
   */
  getDateAsString(aDate: java.util.Date): string;
}
