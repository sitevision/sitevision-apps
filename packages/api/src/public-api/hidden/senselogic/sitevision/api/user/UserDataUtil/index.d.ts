...
interface UserDataUtil {
   ...
   */
  getUserData(aUserDataKey: java.lang.String): unknown;
   ...
   * @return the value for <code>aUserDataKey</code> (typically a <code>String</code>), or null
   */
  getUserData(aUserNode: Node, aUserDataKey: java.lang.String): unknown;
   ...
   */
  setUserData(
    aUserDataKey: java.lang.String,
    aSerializableValue: java.io.Serializable
  ): void;
   ...
   * @param aUserDataKey the data key
   */
  removeUserData(aUserDataKey: java.lang.String): void;
   ...
   * @param aUserDataKey the data key
   */
  removeUserData(aUserNode: Node, aUserDataKey: java.lang.String): void;
}
