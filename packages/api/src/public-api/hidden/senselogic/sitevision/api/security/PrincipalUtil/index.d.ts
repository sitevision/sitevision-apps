...
interface PrincipalUtil {
  ...
  doAsDuringLogin(
    aUser: Node,
    aAction: java.security.PrivilegedExceptionAction
  ): void;
   ...
   */
  getVirtualGroupByName(aName: java.lang.String): Node;
   ...
   * @since Sitevision 3.0
   */
  getVirtualGroupsByName(aNames: java.util.List): unknown[];
}
