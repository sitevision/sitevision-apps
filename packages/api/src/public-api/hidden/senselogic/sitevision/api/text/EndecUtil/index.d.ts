...
interface EndecUtil {
   ...
   */
  escapeXML(aString: java.lang.String): string;
   ...
   */
  unEscapeXML(aString: java.lang.String): string;
   ...
   */
  unEscapeHTML4(aString: java.lang.String): string;
   ...
   */
  encodeURL(aURL: java.lang.String): string;
   ...
   * @since Sitevision 2.6.1_04
   */
  decodeURL(aURL: java.lang.String): string;
   ...
   */
  br(aString: java.lang.String): string;
   ...
   */
  getBaseSubstitute(aString: java.lang.String): string;
   ...
   */
  escapeJcrName(aJcrName: java.lang.String): string;
   ...
   */
  unEscapeJcrName(aJcrName: java.lang.String): string;
   ...
   */
  base64encode(aString: java.lang.String): string;
   ...
   */
  base64encodeToString(aBytes: byte): string;
   ...
   * @since Sitevision 2.6
   */
  base64decode(aBase64EncodedString: java.lang.String): string;
   ...
   * @since Sitevision 4.5.5.2
   */
  base64decodeToBytes(aBase64EncodedString: java.lang.String): unknown;
