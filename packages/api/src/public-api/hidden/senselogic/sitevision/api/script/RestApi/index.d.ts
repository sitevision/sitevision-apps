...
interface RestApi {
   ...
   */
  get(aContextNode: Node, aOperationName: java.lang.String): unknown;
  ...
  get(
    aContextNode: Node,
    aOperationName: java.lang.String,
    aOperationOptions: O
  ): unknown;
   ...
   */
  delete(aContextNode: Node, aOperationName: java.lang.String): unknown;
