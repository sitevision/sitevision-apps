...
interface SiteCookieUtil {
   ...
   */
  resolveSiteCookieByIdentifier(aCookieIdentifier: java.lang.String): Node;
   ...
   */
  createUserConsentCookieValue(aAllowCookieIdList: java.util.List): string;
