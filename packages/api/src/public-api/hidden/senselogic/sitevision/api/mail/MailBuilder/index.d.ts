...
interface MailBuilder {
   ...
   * @return this builder
   */
  setFrom(aFromAddress: java.lang.String): MailBuilder;
   ...
   * @return this builder
   */
  addReplyTo(aReplyToAddress: java.lang.String): MailBuilder;
   ...
   * @return this builder
   */
  setSubject(aSubject: java.lang.String): MailBuilder;
   ...
   * @return this builder
   */
  setTextMessage(aTextMessage: java.lang.String): MailBuilder;
   ...
   */
  setHtmlMessage(aHtmlMessage: java.lang.String): MailBuilder;
   ...
   * @return this builder
   */
  addRecipient(aRecipientAddress: java.lang.String): MailBuilder;
   ...
   * @since Sitevision 3.6.3
   */
  addCopyRecipient(aCopyRecipientAddress: java.lang.String): MailBuilder;
  ...
  addBlindCopyRecipient(
    aBlindCopyRecipientAddress: java.lang.String
  ): MailBuilder;
