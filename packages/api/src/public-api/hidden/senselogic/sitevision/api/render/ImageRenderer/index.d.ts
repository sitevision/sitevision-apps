...
interface ImageRenderer {
   ...
   */
  update(anImageNode: Node, aDescription: java.lang.String): void;
   ...
   */
  setSourceSetMode(
    aSourceSetMode: senselogic.sitevision.api.render.SourceSetMode
  ): void;
   ...
   */
  setDimensionMode(
    aDimensionMode: senselogic.sitevision.api.render.DimensionMode
  ): void;
   ...
   */
  setDescription(aDescription: java.lang.String): void;
