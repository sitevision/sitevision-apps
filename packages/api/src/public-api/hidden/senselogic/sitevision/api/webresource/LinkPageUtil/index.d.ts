...
interface LinkPageUtil {
   ...
   * @throws RepositoryException if something else goes wrong
   */
  renameLinkPage(aLinkPage: Node, aName: java.lang.String): void;
   ...
   * @throws RepositoryException if something else goes wrong
   */
  updateLinkPage(aLinkPage: Node, aProperties: java.util.Map): void;
}
