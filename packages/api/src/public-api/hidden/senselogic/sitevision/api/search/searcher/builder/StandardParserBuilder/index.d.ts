...
interface StandardParserBuilder {
  /**
   ...
   * @return this builder
   */
  setDefaultField(aDefaultField: java.lang.String): StandardParserBuilder;
   ...
   */
  setQueryOperator(aQueryOperator: java.lang.String): StandardParserBuilder;
