...
interface LinkRenderer {
  ...
  update(
    aTarget: Node,
    aFontClass: java.lang.String,
    aText: java.lang.String,
    aTitle: java.lang.String
  ): void;
   ...
   * @see #isValidTarget(javax.jcr.Node)
   */
  update(aTarget: Node, aText: java.lang.String): void;
   ...
   * @see #isValidTarget(javax.jcr.Node)
   */
  updateClean(aTarget: Node, aText: java.lang.String): void;
   ...
   */
  setStringTarget(aTarget: java.lang.String): void;
   ...
   */
  setFontClass(aFontClass: java.lang.String): void;
   ...
   */
  setText(aText: java.lang.String): void;
   ...
   */
  setTitle(aTitle: java.lang.String): void;
   ...
   */
  setStyle(aStyle: java.lang.String): void;
   ...
   */
  setLang(aLang: java.lang.String): void;
   ...
   * @since Sitevision 2022.10.1
   */
  setHrefLang(aHrefLang: java.lang.String): void;
   ...
   */
  addTargetParameter(key: java.lang.String, value: java.lang.String): void;
 ...
 * Removes all existing target parameters
   ...
   * @since Sitevision 3.0
   */
  addDataAttribute(aName: java.lang.String, aValue: java.lang.String): void;
   ...
   */
  setAccessKey(anAccessKey: java.lang.String): void;
   ...
   */
  setRel(aRel: java.lang.String): void;
   ...
   */
  setOnclick(anOnclick: java.lang.String): void;
   ...
   * @since Sitevision 3.0
   */
  setId(anId: java.lang.String): void;
