import NumericFormatterBuilder from "../NumericFormatterBuilder";
...
interface FormatterBuilderFactory {
  /**
   ...
   */
  getNumberFormatterBuilder(aLocale: java.util.Locale): NumericFormatterBuilder;
