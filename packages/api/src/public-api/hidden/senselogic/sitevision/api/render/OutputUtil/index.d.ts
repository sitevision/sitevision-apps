...
interface OutputUtil {
   ...
   */
  getHtmlText(aText: java.lang.String, aFontNode: Node): string;
   ...
   * @since Sitevision 2.6.1_02
   */
  getEscapedHtmlText(aPlainText: java.lang.String, aFontNode: Node): string;
   ...
   */
  getHyperlinkedText(aText: java.lang.String): string;
   ...
   * @since Sitevision 3.0
   */
  getNodeInfoAsHTML(aNode: Node, aDepth: int): string;
