...
interface FileUtil {
   ...
   */
  createFiles(aParent: Node, aFileMappings: java.util.Map): void;
  ...
  createFileFromBase64(
    aParent: Node,
    aFileName: java.lang.String,
    aBase64EncodedString: java.lang.String
  ): Node;
   ...
   */
  updateBinaryContent(aFile: Node, aUri: java.lang.String): void;
   ...
   * @since Sitevision 4.1.1
   */
  getContentAsString(aFile: Node, aCharacterEncoding: java.lang.String): string;
   ...
   */
  renameFile(aFile: Node, aNewName: java.lang.String): void;
