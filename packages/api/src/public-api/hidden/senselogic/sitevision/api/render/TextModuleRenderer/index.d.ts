...
interface TextModuleRenderer {
   ...
   */
  updateByName(aTextModuleName: string): void;
   ...
   */
  updateByIdentifier(aTextModuleIdentifier: string): void;
...
export default TextModuleRenderer;
