import RequesterChainable from "../RequesterChainable";
...
interface Requester {
   ...
   */
  get(aURL: java.lang.String): RequesterChainable;
   ...
   * @return a chainable requester
   */
  get(aURL: java.lang.String, aOptions: O): RequesterChainable;
   ...
   * @return a chainable requester
   */
  put(aURL: java.lang.String): RequesterChainable;
   ...
   * @return a chainable requester
   */
  put(aURL: java.lang.String, aOptions: O): RequesterChainable;
   ...
   * @return a chainable requester
   */
  post(aURL: java.lang.String): RequesterChainable;
   ...
   * @return a chainable requester
   */
  post(aURL: java.lang.String, aOptions: O): RequesterChainable;
   ...
   * @return a chainable requester
   */
  delete(aURL: java.lang.String): RequesterChainable;
   ...
   * @return a chainable requester
   */
  delete(aURL: java.lang.String, aOptions: O): RequesterChainable;
   ...
   */
  patch(aURL: java.lang.String): RequesterChainable;
   ...
   * @since Sitevision 7.2.3
   */
  patch(aURL: java.lang.String, aOptions: O): RequesterChainable;
   ...
   * @since Sitevision 7.2.3
   */
  head(aURL: java.lang.String): RequesterChainable;
   ...
   * @since Sitevision 7.2.3
   */
  head(aURL: java.lang.String, aOptions: O): RequesterChainable;
}
