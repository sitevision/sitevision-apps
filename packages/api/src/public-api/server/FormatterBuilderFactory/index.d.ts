...
export interface FormatterBuilderFactory {
   ...
   */
  getNumberFormatterBuilder(aLocale: unknown): NumericFormatterBuilder;
   ...
   * @throws NullPointerException if aLocale is null
   */
  getPercentFormatterBuilder(aLocale: unknown): NumericFormatterBuilder;
   ...
   */
  getCurrencyFormatterBuilder(aLocale: unknown): NumericFormatterBuilder;
