 ...
 */
export function getTagByName(aTagName: string): Node;
 ...
 */
export function getOrCreateTagByName(aTagName: string): Node;
 ...
 */
export function addTag(aTaggableNode: Node, aTagNode: Node): void;
 ...
 * @throws RepositoryException if mutation is not allowed or fails
 */
export function addTags(aTaggableNode: Node, aTagNodes: Node): void;
 ...
 * @throws RepositoryException if mutation is not allowed or fails
 */
export function removeTag(aTaggableNode: Node, aTagNode: Node): boolean;
 ...
 */
export function getTags(aTaggableNode: Node): unknown;
