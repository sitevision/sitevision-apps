 ...
 */
export function hasPermission(aPermission: unknown): boolean;
 ...
 * @since Sitevision 3.6
 */
export function hasPermissions(aPermissions: unknown): boolean;
 ...
 * @since Sitevision 3.6
 */
export function hasPermission(aTreeNode: Node, aPermission: unknown): boolean;
 ...
 * @since Sitevision 3.6
 */
export function hasPermissions(aTreeNode: Node, aPermissions: unknown): boolean;
