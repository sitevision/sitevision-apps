...
export interface UserFieldRenderer {
   ...
   */
  isValidFieldName(aUserFieldName: string): boolean;
   ...
   */
  render(aUserFieldName: string): string;
   ...
   * @see #render(String)
   */
  renderPlain(aUserFieldName: string): string;
   ...
   * @since Sitevision 3.6
   */
  getPlainUserFieldValueAsHtml(aPlainUserFieldValue: string): string;
}
