 ...
 */
export function getMimeType(aFileExtensionExpression: string): string;
 ...
 */
export function getExtension(aMimeType: string): string;
 ...
 */
export function isImageType(aFileExtensionExpression: string): boolean;
 ...
 */
export function isTextType(aFileExtensionExpression: string): boolean;
 ...
 * @since Sitevision 4.1
 */
export function isXmlType(aFileExtensionExpression: string): boolean;
 ...
 * @since Sitevision 4.1
 */
export function isVideoType(aFileExtensionExpression: string): boolean;
 ...
 * @since Sitevision 4.1
 */
export function isCompressedType(aFileExtensionExpression: string): boolean;
 ...
 * @since Sitevision 4.1
 */
export function isMSWordType(aFileExtensionExpression: string): boolean;
 ...
 * @since Sitevision 4.1
 */
export function isMSExcelType(aFileExtensionExpression: string): boolean;
 ...
 * @since Sitevision 4.1
 */
export function isMSPowerpointType(aFileExtensionExpression: string): boolean;
 ...
 * @since Sitevision 4.1
 */
export function isMSOfficeType(aFileExtensionExpression: string): boolean;
 ...
 */
export function isFontType(aFileExtensionExpression: string): boolean;
