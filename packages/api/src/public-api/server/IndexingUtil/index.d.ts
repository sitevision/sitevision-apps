 ...
 */
export interface IndexingUtil extends IndexingUtilConstants {
  /**
 * The minimum resource priority.
 *
 * A resource indexed with this priority value will get a document boost of <code>0.1F</code>.
  
    */
  MIN_RESOURCE_PRIORITY: 0;

  /**
 * The default resource priority.
 *
 * A resource indexed with this priority value will get the default document boost of <code>1.0F</code>.
  
    */
  DEFAULT_RESOURCE_PRIORITY: 5;
