 ...
 */
export function createFolder(aParent: Node, aName: string): Node;
 ...
 * @throws RepositoryException if something else goes wrong
 */
export function renameFolder(aFolder: Node, aName: string): void;
 ...
 */
export function setVersioned(aFolder: Node, aVersioned: boolean): void;
...
declare namespace folderUtil {
  export { createFolder, renameFolder, setVersioned, setDownloadProtected };
}
