...
export interface EndecUtil {
   ...
   */
  escapeXML(aString: string): string;
   ...
   */
  unEscapeXML(aString: string): string;
   ...
   */
  unEscapeHTML4(aString: string): string;
   ...
   */
  getBaseSubstitute(aString: string): string;
   ...
   */
  escapeJcrName(aJcrName: string): string;
   ...
   */
  unEscapeJcrName(aJcrName: string): string;
   ...
   */
  base64encode(aString: string): string;
   ...
   */
  base64encodeToString(aBytes: unknown): string;
   ...
   * @since Sitevision 2.6
   */
  base64decode(aBase64EncodedString: string): string;
   ...
   * @since Sitevision 4.5.5.2
   */
  base64decodeToBytes(aBase64EncodedString: string): unknown;
   ...
   */
  escapeIdentifier(aPrefix: string, anIdentifier: string): string;
   ...
   * @since Sitevision 3.0.2
   */
  unEscapeIdentifier(aPrefix: string, anIdentifier: string): string;
}
