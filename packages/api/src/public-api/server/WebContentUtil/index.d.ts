...
export interface WebContentUtil {
   ...
   */
  updateContent(aNode: Node, aContent: String | string): void;
   ...
   * @see senselogic.sitevision.api.security.PermissionUtil#hasEffectiveWritePermission(Node, Node)
   */
  updateContent(aNode: Node, aContent: Map | {}): void;
   ...
   * @see senselogic.sitevision.api.security.PermissionUtil#hasEffectiveWritePermission(Node, Node)
   */
  updateContentWithRawHtml(aNode: Node, aContent: String | string): void;
   ...
   * @see senselogic.sitevision.api.security.PermissionUtil#hasEffectiveWritePermission(Node, Node)
   */
  updateContentWithRawHtml(aNode: Node, aContent: Map | {}): void;
   ...
   * @see senselogic.sitevision.api.security.PermissionUtil#hasEffectiveWritePermission(Node, Node)
   */
  appendContent(aNode: Node, aContent: String | string): void;
   ...
   * @see senselogic.sitevision.api.security.PermissionUtil#hasEffectiveWritePermission(Node, Node)
   */
  appendContent(aNode: Node, aContent: Map | {}): void;
   ...
   * @see senselogic.sitevision.api.security.PermissionUtil#hasEffectiveWritePermission(Node, Node)
   */
  appendContentWithRawHtml(aNode: Node, aContent: String | string): void;
   ...
   * @see senselogic.sitevision.api.security.PermissionUtil#hasEffectiveWritePermission(Node, Node)
   */
  appendContentWithRawHtml(aNode: Node, aContent: Map | {}): void;
