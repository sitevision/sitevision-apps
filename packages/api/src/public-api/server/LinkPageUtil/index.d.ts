 ...
 * @throws RepositoryException if something else goes wrong
 */
export function renameLinkPage(aLinkPage: Node, aName: string): void;
 ...
 * @throws RepositoryException if something else goes wrong
 */
export function updateLinkPageTarget(
  aLinkPage: Node,
  aLinkTarget: LinkTarget
): void;
 ...
 * @throws RepositoryException if something else goes wrong
 */
export function updateLinkPage(aLinkPage: Node, aProperties: unknown): void;
 ...
 * </p>Name of the property specifying if a link page is visible in menus. It corresponds to the sv:link property <code>visibleInMenus</code>.
 * <p>
 *    The property value must be of type <code>Boolean</code>.
 * </p>Name of the property specifying the creation date of a link page. It corresponds to the sv:link property <code>creationDate</code>.
 * <p>
 ...
 * </p>Name of the property specifying the creator of a link page. It corresponds to the sv:link property <code>createdBy</code>.
 * <p>
 *    The property value must be a {@link javax.jcr.Node} with primary node type sv:user or sv:systemUser.
 * </p>Name of the property specifying the last modified date of a link page. It corresponds to the sv:link property <code>lastModifiedDate</code>.
 * <p>
 *    The property value must be of type <code>Date</code> or a <code>String</code> on format yyyy-MM-dd HH:mm:ss,
 *    where HH:mm:ss is optional (defaults to 00:00:00).
 * </p>Name of the property specifying the last modifier of a link page. It corresponds to the sv:link property <code>lastModifiedBy</code>.
 * <p>
 *    The property value must be a {@link javax.jcr.Node} with primary node type sv:user or sv:systemUser.
 * </p>Name of the property specifying the last published date of a link page. It corresponds to the sv:link property <code>lastPublishDate</code>.
 * <p>
 *    The property value must be of type <code>Date</code> or a <code>String</code> on format yyyy-MM-dd HH:mm:ss,
 *    where HH:mm:ss is optional (defaults to 00:00:00).
 * </p>Name of the property specifying the last publisher of a link page. It corresponds to the sv:link property <code>lastPublishedBy</code>.
 * <p>
 *    The property value must be a {@link javax.jcr.Node} with primary node type sv:user or sv:systemUser.
 * </p>Name of the property specifying the published date of a link page. It corresponds to the sv:link property <code>publishDate</code>.
 * <p>
 *    The property value must be of type <code>Date</code> or a <code>String</code> on format yyyy-MM-dd HH:mm:ss,
 *    where HH:mm:ss is optional (defaults to 00:00:00).
 * </p>Name of the property specifying the publisher of a link page. It corresponds to the sv:link property <code>publishedBy</code>.
 * <p>
 *    The property value must be a {@link javax.jcr.Node} with primary node type sv:user or sv:systemUser.
 * </p>
