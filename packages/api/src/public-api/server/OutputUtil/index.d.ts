 ...
 * The "text/xml" content-type marker
   ...
   */
  getHtmlText(aText: String | string, aFontNode: Node): string;
   ...
   * @since Sitevision 2.6.1_02
   */
  getEscapedHtmlText(aPlainText: String | string, aFontNode: Node): string;
   ...
   */
  getHyperlinkedText(aText: String | string): string;
