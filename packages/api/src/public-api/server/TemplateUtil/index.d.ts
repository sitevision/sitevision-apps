 ...
 */
export function getTemplateByName(aTemplateName: string): Node;
 ...
 * @since Sitevision 4.1
 */
export function getPageTemplateByName(aPageTemplateName: string): Node;
 ...
 * @since Sitevision 4.1
 */
export function getPageTemplates(): unknown;
 ...
 * @since Sitevision 4.1
 */
export function isPageTemplate(aTemplate: Node): boolean;
 ...
 * @since Sitevision 4.1
 */
export function getContentAreaNames(aTemplate: Node): unknown;
