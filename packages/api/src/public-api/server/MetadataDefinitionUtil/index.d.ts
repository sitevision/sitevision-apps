 ...
 */
export function getDefinition(aNode: Node, aDefinitionName: string): Node;
 ...
 */
export function getDefinitions(aNode: Node): unknown;
 ...
 */
export function renameAlternative(
  aNode: Node,
  aDefinitionName: string,
  aAlternativeName: string,
