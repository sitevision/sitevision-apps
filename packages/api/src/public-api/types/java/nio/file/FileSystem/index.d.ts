...
import type { UserPrincipalLookupService } from "../attribute/UserPrincipalLookupService";
...
export type FileSystem = Object &
  Closeable & {
     ...
     */
    getPathMatcher(syntaxAndPattern: String | string): PathMatcher;
