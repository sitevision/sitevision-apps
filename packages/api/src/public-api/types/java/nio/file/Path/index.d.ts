...
export type Path = Comparable &
  ...
  Watchable & {
     ...
     */
    startsWith(other: String | string): boolean;
     ...
     * @throws InvalidPathException&#xA; If the path string cannot be converted to a Path.
     */
    endsWith(other: String | string): boolean;
     ...
     */
    resolve(other: String | string): Path;
     ...
     * @see FileSystem#getPath
     */
    resolveSibling(other: String | string): Path;
