 ...
 * @since 1.8
 */
export type Chronology = Comparable & {
  /**
   ...
   */
  from(temporal: TemporalAccessor): Chronology;
   ...
   */
  of(id: String | string): Chronology;
   ...
   */
  localDateTime(temporal: TemporalAccessor): ChronoLocalDateTime;
   ...
   */
  zonedDateTime(temporal: TemporalAccessor): ChronoZonedDateTime;
   ...
   */
  zonedDateTime(instant: Instant, zone: ZoneId): ChronoZonedDateTime;
