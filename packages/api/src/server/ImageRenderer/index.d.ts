...
declare namespace imageRenderer {
  ...
  * @param {boolean} useAutoTitle - whether or not the renderer should try to get a description via metadata to use as title value if no description
                       is available 
  */
  ...
  * @param {boolean} useImageScaler - decides if an image scaler should be used or not.
      If true, an image scaler will be used if it is set. If false, no image scaler will be used even if it is set. 
  */
